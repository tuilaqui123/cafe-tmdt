...
const CheckOut = () => {
    ...
    return (
        <>
            {
                !isLoading ? <div className='lg:mx-20 mx-4'>
                    <div className='flex mt-5 items-center' >
                        <AiOutlineArrowLeft />
                        <p className=' text-[15px] text-black ml-2'>Back to cart</p>
                    </div>

                    <p className='lg:text-[38px] text-[30px] font-bold text-black mt-5'>Complete order, Sophia</p>

                    <div className='mt-3'>
                        <div className='hover:opacity-90 bg-black h-[40px] md:hidden rounded-[5px]' onClick={() => { setIsOpen(!isOpen) }}>
